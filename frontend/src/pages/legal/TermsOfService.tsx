        ...
        <div className="space-y-0">
          ...
          <section className="py-6 border-b border-[#2a2a2a]">
            ...
            <p className="text-sm leading-relaxed text-[#b0b0b0]">
              Melovar 是一个面向全球（巴西除外）用户提供 AI 音乐与音频创作工具的平台，功能可能包括 AI 音乐生成、音频编辑、多轨混音、MIDI 编辑、协作、社区分发、存储与内容分发加速等。平台免费提供约 80% 核心功能的体验，部分高级功能需通过订阅或按量付费等方式使用。平台会尽合理努力维护服务稳定，但受技术、第三方服务及合规等因素影响，不保证服务在任何特定场景下均完全无误或持续可用。具体功能、可用性及限制以平台实时展示及相关说明为准。
            </p>
          </section>
