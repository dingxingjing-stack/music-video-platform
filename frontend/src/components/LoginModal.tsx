...
export function LoginModal() {
  const { showLogin, setShowLogin, login, loginWithGoogle, googleLoginEnabled } = useAuth();
  const { t } = useTranslation();
        ...
        <form onSubmit={submitEmail} className="space-y-4">
          ...
          {googleLoginEnabled && (
            <>
              ...
              <button type="button" onClick={submitGoogle} disabled={submitting} className="w-full py-3 bg-[#1e1e1e] border border-[#2a2a2a] text-white font-semibold rounded-lg hover:bg-[#262626] transition disabled:opacity-50">
